...
const props = {
  ...
  header: "Update brand",
  description: "Make changes to a brand's basic information.",
  fields: [
    {
      name: "name",
      type: "text",
...
function UpdateBrandInfoForm({ currentValues }) {
...
UpdateBrandInfoForm.propTypes = {
  currentValues: PropTypes.objectOf(PropTypes.string)
};

UpdateBrandInfoForm.defaultProps = {
  currentValues: {}
};
